...
grayA12 = glmmTMB(MaxN ~ coral + sand + algae + sponge, family = nbinom2(), data = df_gray_A)
grayA13 = glmmTMB(MaxN ~ coral + sand + algae  + sponge, family = compois(), data = df_gray_A)

AICc(grayA1, grayA12,grayA13)

#We can also come to the same conclusion with DHARMa. MODEL SEEMS TO BE OVERDISPERSED BASED ON THE DIFFERENT TESTS
SimulationOutput1 <- simulateResiduals(fittedModel = grayA13, 
                                       refit = FALSE, 
                                       seed = 12345)
